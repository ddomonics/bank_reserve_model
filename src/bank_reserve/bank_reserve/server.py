...
from src.bank_reserve.bank_reserve.agents import Person
from src.bank_reserve.bank_reserve.model import BankReserves
...
model_params = {
    ...
    "interest_rate": mesa.visualization.Slider(
        "Interest Rate",
        0.05,
        0.01,
        0.2,
...
# New chart for Total Loans
loans_chart_element = mesa.visualization.ChartModule(
    [
        {"Label": "Total Loans", "Color": "#9467bd"},  # Purple color for loans
    ],
...
server = mesa.visualization.ModularServer(
    BankReserves,
    [canvas_element, chart_element, loans_chart_element],  # Add loans_chart_element here
    "Bank Reserves Model",
