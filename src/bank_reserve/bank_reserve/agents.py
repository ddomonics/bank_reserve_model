...
import mesa
from src.bank_reserve.bank_reserve.random_walk import RandomWalker
...
class Person(RandomWalker):
    ...
    def apply_interest(self):
        if self.loans > 0:
            interest = self.loans * self.bank.model.interest_rate
            self.loans += interest
            # A bank számára is nyilvántartjuk a kamatot
    ...
    def step(self):
        ...
        self.balance_books()
        self.apply_interest()  # Apply interest on the loan
